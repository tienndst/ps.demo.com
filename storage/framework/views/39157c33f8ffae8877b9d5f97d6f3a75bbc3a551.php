    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top navbar-fixed-top" role="navigation" style="margin-bottom: 0 ;">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo e(url('/admin')); ?>">Admin</a>
                <a class="navbar-brand" href="/">Về home</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <?php if(Auth::check()): ?>
                            ...
                            <li class="divider"></li>
                            <li><a href="<?php echo url('/logout'); ?>"><i class="fa fa-sign-out fa-fw"></i>  <?php echo e(trans('translate.Logout')); ?></a>
                            </li>
                        <?php endif; ?>
                    </ul>
                    <!-- /.dropdown-user -->
